...
import { clearCart, removeFromCart } from '../../redux/features/cart/cartSlide'
                      ...
                      <li key={product?._id} className="flex py-6">
                        ...
                        <div className="ml-4 flex flex-1 flex-col">
                          <div>
                            ...
                            <p className="mt-1 text-sm text-gray-500 capitalize"><strong>Category:
                            </strong>{product?.category}</p>
                          </div>
